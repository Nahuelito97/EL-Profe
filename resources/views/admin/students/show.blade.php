            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-md-11 mx-auto px-0 dashboard_route">
                        <p> > Dashboard <span class="ml-2"> > Students</span><span class="ml-2"> >Edit</span></p>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="card bg-light d-flex flex-fill">
                                                            <div class="card-header text-muted border-bottom-0">
                                                                ...
                                                                <h2 class="lead"><b> {{ $studentss->name }}</b></h2>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="row">
                                                                    <div class="col-7">
                                                                        <p class="text-muted text-sm">
                                                                            <b>Surname: </b> {{ $studentss->surname }}
                                                                        </p>
                                                                        <p class="text-muted text-sm">
                                                                            <b>Dni: </b> {{ $studentss->dni }}
                                                                        </p>
                                                                        <p class="text-muted text-sm">
                                                                            <b>DateofBirth:
                                                                            </b>{{ date('d-m-Y', strtotime($studentss->date_of_birth)) }}
                                                                        </p>
                                                                        <p class="text-muted text-sm">
                                                                            <b>Email: </b>{{ $studentss->email }}
                                                                        </p>
                                                                        <p class="text-muted text-sm">
                                                                            <b>DateofAdress:
                                                                            </b> {{ date('d-m-Y', strtotime($studentss->date_of_address)) }}
                                                                        </p>
                                                                        <h5>
                                                                            </h2>
                                                                            <h5>
