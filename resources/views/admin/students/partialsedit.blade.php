<div class="card-body">
    <form class="" method="post" action="{{ route('studentss.update', $studentss) }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name"
                            ...
                            value="{{ old('date_of_birth', $studentss->name) }}" id="name"
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('date_of_birth', $studentss->phone) }}"
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('date_of_birth', $studentss->dni) }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        value="{{ old('date_of_birth', $studentss->surname) }}"
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('date_of_birth', $studentss->email) }}"
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('date_of_birth', $studentss->date_of_birth) }}" id="date_of_birth"
                            placeholder="Ingrese un nombre para el alumno">
                        @error('date_of_birth')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
