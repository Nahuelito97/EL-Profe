        ...
        <div class="content-header pt-3 pb-3 px-0 bg-white">
            <div class="container-fluid">
                ...
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Profesorss</h5>
                    <div class="row mb-2">
                        <div class="col-md-11 mx-auto px-0 dashboard_route">
                            <p> > Dashboard <span class="ml-2"> > Profesorss</span></p>
                        </div>
                    </div><!-- /.row -->.
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="card card-default">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="{{ route('profesorss.store') }}"
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::text('name', $profesorss ?? (('')->name ?? null), ['id' => 'name', 'placeholder' => 'Write the student name', 'class' => 'form-control']) }}
                                                                @error('name')
                                                                    <span
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::text('surname', $profesorss ?? (('')->surname ?? null), ['id' => 'surname', 'placeholder' => 'Write the student surname', 'class' => 'form-control']) }}
                                                                @error('surname')
                                                                    <span
                                                                        class="text-danger text-error">{{ $message }}</span>
                                                                @enderror
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::text('email', $profesorss ?? (('')->email ?? null), ['id' => 'email', 'placeholder' => 'Write the student mail', 'class' => 'form-control']) }}
                                                                @error('email')
                                                                    <span
                                                                        class="text-danger text-error">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::text('phone', $profesorss ?? (('')->phone ?? null), ['id' => 'phone', 'placeholder' => 'Write the student Phone', 'class' => 'form-control']) }}
                                                                @error('phone')
                                                                    <span
                                                                        class="text-danger text-error">{{ $message }}</span>
                                                                @enderror
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            class="{{ Auth::user()->hasRole('SuperAdmin|Admin') ? 'col-md-2' : 'col-md-2' }}">
                                                            <div class="form-group layout_subtitle">
                                                                {!! htmlspecialchars_decode(Form::label('dni', 'Dni <span>*</span>', ['class' => 'layout_subtitle'])) !!}
                                                                {{ Form::text('dni', $profesorss ?? (('')->dni ?? null), ['id' => 'dni', 'placeholder' => 'write the student dni', 'class' => 'form-control']) }}
                                                                @error('dni')
                                                                    <span
                                                                        class="text-danger text-error">{{ $message }}</span>
                                                                @enderror
                                                                    ...
                                                                    <div class="col clearfix">
                                                                        <ul class="pagination justify-content-end">
                                                                            <div class="form-group layout_subtitle">
                                                                                <div class="d-flex">
                                                                                    <div class="from-group has-feedback">
                                                                                        <label for="especialitis_id"
                                                                                            class="control-label text-semibold">Select
                                                                                            a Especiality</label>
                                                                                        <select id="especialitis_id"
                                                                                            class="form-control @error('especialitis_id') is-invalid @enderror"
                                                                                            name="especialitis_id"
                                                                                            data-toggle="tooltip"
                                                                                            data-placement="top"
                                                                                            title="">
                                                                                            <option value="#" selected
                                                                                                disabled>Especiality</option>
                                                                                            @foreach ($especialitis as $especialiti)
                                                                                                @if (old('especialitis_id') == $especialiti->id)
                                                                                                    <option
                                                                                                        value="{{ $especialiti->id }}"
                                                                                                        selected>
                                                                                                        {{ $especialiti->name }}
                                                                                                    </option>
                                                                                                @else
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::date('date_of_birth', $profesorss ?? (('')->date_of_birth ?? null), ['id' => 'date_of_birth', 'placeholder' => 'Add a start date', 'class' => 'form-control']) }}
                                                                @error('date_of_birth')
                                                                    <span
                                                                        class="text-danger text-error">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group layout_subtitle">
                                                                ...
                                                                {{ Form::date('date_of_address', $profesorss ?? (('')->date_of_address ?? null), ['id' => 'date_of_address', 'placeholder' => 'Add a finish date', 'class' => 'form-control']) }}
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col d-flex align-items-center justify-content-end">
                                                            ...
                                                            <button type="submit" class="btn btn-primary btn-rounded "><i
                                                                    class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Add Profesor</button>
                                                        </div>
