<div class="card-body">
    <form method="POST" action="{{ route('profesorss.store') }}" class="formulario-crear">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="from-group has-feedback">
                <label for="especialitis_id" class="control-label text-semibold">
                    <h5>Selecciona una Especialdiad:<span class="text-danger">*</span></h5>
                </label>
            ...
            <div class="from-group">
                <label for="pais_id" class="control-label text-semibold">
                    <h5>Selecciona una Pais:<span class="text-danger">*</span></h5>
                </label>
                <select id="pais_id" class="form-control @error('pais_id') is-invalid @enderror" name="pais_id"
                    data-toggle="tooltip" data-placement="top" title="Selecciona una Especialidad">
        ...
        <div class="col-xs-12">
            <p class="text-center">
                ...
                <a class="btn btn-primary btn-rounded" href="{{ route('profesorss.index') }}">Back</a>
            </p>
        </div>
